...
public class EnviaEmail implements Serializable {
    ...
    public EnviaEmail(String miCorreo, String miContrasena, String mailReceptor, String asunto, String cuerpo) {
    ...
    private class autentificadorSMTP extends javax.mail.Authenticator {
        ...
        public PasswordAuthentication getPasswordAuthentication() {
            return new PasswordAuthentication(miCorreo, miContrasena);//autentifica tanto el correo como la contraseña
        }
    }
}
